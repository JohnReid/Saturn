...
for (i in 1:nrow(true.pos)) {
    plot.ranges(regions.to.ranges(true.pos[i,]), cell.valid, motif.scans)
}
```
...
for (i in 1:nrow(false.neg)) {
    plot.ranges(regions.to.ranges(false.neg[i,]), cell.valid, motif.scans)
}
```
...
for (i in 1:nrow(false.pos)) {
    plot.ranges(regions.to.ranges(false.pos[i,]), cell.valid, motif.scans)
}
```
